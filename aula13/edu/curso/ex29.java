...
public class GestaoPet {
    ...
    public void cadastrar() { 
        System.out.println("Informe qual atendimento deseja pro seu pet!\n\n");
        Chamado c = new Chamado();

        System.out.println("Banho e tosa");
        c.fila = scan.nextLine();
        System.out.println("Só banho");
        c.descricao = scan.nextLine();
        System.out.println("Informe a prioridade do atendimento");
    ...
    public void pesquisarPorFila() { 
        ...
        System.out.println("Informe o numero do cadastro para ver os chamados");
